...
class SympySolveToolsTester:
    def testReverseSubstituteForBadNumerics(self):
        expr = a + b**two
        equation = 2 - expr
        solution = _SympySolveTools.Solution(sympy.solveset(equation, 2))
    ...
    def testSolveSetPerformsSolving(self):
        ...
        actualSolution1 = {4}
        toolsSolution1 = _SympySolveTools.solveSet(expr, a + b*c).set
        assert toolsSolution1 == actualSolution1

        actualSolution2 = {b*c}
        toolsSolution2 = _SympySolveTools.solveSet(expr, -(a - 4)).set
    ...
    def testSolveSetSolvesForNumerics(self):
        ...
        toolsSolution1 = _SympySolveTools.solveSet(expr, 2).set
        assert toolsSolution1 == actualSolution1
